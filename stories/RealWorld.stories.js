...
storiesOf('RealWorld - authenticated', module)
  ...
  .add('RealWorld - user authenticated, no tag filter, correct activeFeed, correct page, fetched tags, loading articles', () => ({
    Component: RealWorld,
  ...
  .add('RealWorld - user authenticated, no tag filter, correct activeFeed, page 0, fetched tags, fetched articles', () => ({
    Component: RealWorld,
  ...
  .add('RealWorld - user authenticated, no tag filter, correct activeFeed, page 1, fetched tags, fetched articles', () => ({
    Component: RealWorld,
  ...
  .add('RealWorld - user authenticated, no tag filter, correct activeFeed, page 1, fetched tags, failed fetched articles', () => ({
    Component: RealWorld,
  ...
  .add('RealWorld - user authenticated, no tag filter, correct activeFeed, page 0, failed fetched tags, fetched articles', () => ({
    Component: RealWorld,
  ...
  .add('RealWorld - user authenticated, no tag filter, correct activeFeed, page 0, failed fetched tags, failed fetched articles', () => ({
    Component: RealWorld,
...
// TODO: add the user authenticated stories
//   export let changePage;
//   export let favorite;
//   export let unfavorite;
// TODO: think about removing the edge cases, or putting there at the end?? I need organization here
