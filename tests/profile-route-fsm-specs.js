...
const USER_SEES_OWN_PROFILE_AND_ARTICLES_LIKES_UNLIKES_CHANGES_PAGE_COMMANDS = [
  ...
  [
    ...
    [
      {[RENDER_PROFILE]: {
        route: profile, profileTab: USER_PROFILE_PAGE, user: UNAUTH_USER, profile: ownUserProfileFixture, articles: ARTICLES_ARE_LOADING, favoriteStatus: null, page: 0}
    },
  ],
  [
    {[RENDER_PROFILE]: {
        route: profile, profileTab: USER_PROFILE_PAGE, user: UNAUTH_USER, profile: ownUserProfileFixture, articles: articlesFixture, favoriteStatus: null, page: 0}
    },
  ],
  [
    {[RENDER_PROFILE]: {
        route: profile, profileTab: USER_PROFILE_PAGE, user: UNAUTH_USER, profile: ownUserProfileFixture, articles: articlesFixture, favoriteStatus: unfavoritedSlugFixture, page: 0}
    },
    {[FAVORITE_ARTICLE]: { slug: unfavoritedSlugFixture}},
  ],
  [
    {[RENDER_PROFILE]: {
        route: profile, profileTab: USER_PROFILE_PAGE, user: UNAUTH_USER, profile: ownUserProfileFixture, articles: updatedLikedArticlesFixture, favoriteStatus: null, page: 0}
    },
  ],
  [
    {[RENDER_PROFILE]: {
        route: profile, profileTab: USER_PROFILE_PAGE, user: UNAUTH_USER, profile: ownUserProfileFixture, articles: updatedLikedArticlesFixture, favoriteStatus: unfavoritedSlugFixture, page: 0}
    },
    {[FAVORITE_ARTICLE]: { slug: unfavoritedSlugFixture}},
  ],
  [
  ...
  [
    ...
    {[RENDER_PROFILE]: {
        route: profile, profileTab: USER_PROFILE_PAGE, user: UNAUTH_USER, profile: null, articles: ARTICLES_ARE_LOADING, favoriteStatus: null, page: 1}
    },
  ],
  [
    {[RENDER_PROFILE]: {
        route: profile, profileTab: USER_PROFILE_PAGE, user: UNAUTH_USER, profile: ownUserProfileFixture, articles: ARTICLES_ARE_LOADING, favoriteStatus: null, page: 1}
    },
  ],
  [
    {[RENDER_PROFILE]: {
        route: profile, profileTab: USER_PROFILE_PAGE, user: UNAUTH_USER, profile: ownUserProfileFixture, articles: articlesPage1Fixture, favoriteStatus: null, page: 1}
    },
  ],
];
