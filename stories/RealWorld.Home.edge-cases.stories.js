...
const allPropsUndefined = { route: home};
...
storiesOf('RealWorld - edge cases', module)
  .add('RealWorld - all props undefined but route', () => ({
    Component: RealWorld,
  ...
  .add('RealWorld - user not authenticated, no tag filter, correct activeFeed, page 0, loading articles', () => ({
    Component: RealWorld,
    props: { route: home, articles: articlesLoadingFixture, tags:null, page: 0, activeFeed: GLOBAL_FEED, user: null  },
    on: { },
  }))
  .add('RealWorld - user not authenticated, no tag filter, correct activeFeed, page 0, loading tags', () => ({
    Component: RealWorld,
    props: { route: home, articles: null, tags:tagsLoadingFixture, page: 0, activeFeed: GLOBAL_FEED, user: null  },
    on: { },
  }))
  .add('RealWorld - user not authenticated, no tag filter, incorrect activeFeed, page 0, loading articles', () => ({
    Component: RealWorld,
    props: { route: home, articles: articlesLoadingFixture, tags:null, page: 0, activeFeed: USER_FEED, user: null  },
    on: { },
  }))
  .add('RealWorld - user not authenticated, no tag filter, incorrect activeFeed, page 0, loading tags', () => ({
    Component: RealWorld,
    props: { route: home, articles: null, tags:tagsLoadingFixture, page: 0, activeFeed: TAG_FILTER_FEED, user: null, onClickUserFeedTab, onClickGlobalFeedTab, onClickPage, onClickFavorite  },
    on: { },
  }))
  .add('RealWorld - user not authenticated, no tag filter, correct activeFeed, correct page, error fetch tags', () => ({
    Component: RealWorld,
    props: { route: home, articles: null, tags:tagsErrorFixture, page: 0, activeFeed: GLOBAL_FEED, user: null, onClickUserFeedTab, onClickGlobalFeedTab, onClickPage, onClickFavorite  },
    on: { },
  }))
  .add('RealWorld - user not authenticated, tag filter, USER_FEED active, page 0, failed fetched tags, failed fetched articles', () => ({
    Component: RealWorld,
    props: { route: home, articles: articlesErrorFixture, tags:tagsErrorFixture, page: 0, activeFeed: USER_FEED, user: null, selectedTag: tagFixture, onClickUserFeedTab, onClickGlobalFeedTab, onClickPage, onClickFavorite  },
    on: { },
  }))
  ...
  .add('RealWorld - user not authenticated, tag filter, USER_FEED active, page 0, fetched tags, fetched articles', () => ({
    Component: RealWorld,
    props: { route: home, articles: articlesFixture, tags:tagsFixture, page: 0, activeFeed: USER_FEED, user: null, selectedTag: tagFixture, onClickUserFeedTab, onClickGlobalFeedTab, onClickPage, onClickFavorite  },
    on: { },
  }))
  .add('RealWorld - user not authenticated, tag filter, GLOBAL_FEED active, page 0, failed fetched tags, failed fetched articles', () => ({
    Component: RealWorld,
    props: { route: home, articles: articlesErrorFixture, tags:tagsErrorFixture, page: 0, activeFeed: GLOBAL_FEED, user: null, selectedTag: tagFixture, onClickUserFeedTab, onClickGlobalFeedTab, onClickPage, onClickFavorite  },
    on: { },
  }))
  // Wrong feed
  .add('RealWorld - user authenticated, no tag filter, correct activeFeed, page 1, loading tags, loading articles', () => ({
    Component: RealWorld,
    props: { route: home, articles: articlesLoadingFixture, tags:tagsLoadingFixture, page: 1, activeFeed: GLOBAL_FEED, user: userFixture, onClickUserFeedTab, onClickGlobalFeedTab, onClickPage, onClickFavorite  },
    on: { },
  }))
  ...
  .add('RealWorld - user authenticated, tag filter, TAG_FILTER_FEED, page 0, fetched tags, no articles, clicked on article', () => ({
    Component: RealWorld,
    props: { route: home, articles: articlesEmptyFixture, tags:tagsFixture, page: 0, activeFeed: TAG_FILTER_FEED, user: userFixture, dispatch, selectedTag: tagFixture, favoriteStatus : favoriteStatusFixture },
    on: { },
  }))
